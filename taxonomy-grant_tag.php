<?php
/**
 * Tag Archive Template for Grant - 図鑑風デザイン統一版
 * タグ別助成金アーカイブページ - archive-grant.phpベース
 * 
...
$tag_slug = $current_term->slug;
$tag_description = $current_term->description;
$tag_count = $current_term->count;
$tag_id = $current_term->term_id;
...
// タイトル・説明文の生成
$archive_title = '#' . $tag_name . ' の補助金・助成金';
...
<?php
// title タグ用
$seo_title = '#' . $tag_name . 'の補助金・助成金一覧【' . $current_year . '年度最新版】' . number_format($tag_count) . '件';
...
<main id="main-content" class="site-main" role="main">
    ...
    <section class="zukan-hero zukan-hero-simple">
        <div class="yahoo-container">
            <div class="zukan-hero-content">
                <span class="zukan-hero-label">Tag Archive</span>
    ...
    <div class="yahoo-container yahoo-two-column-layout zukan-two-column">
        ...
        <div class="yahoo-main-content zukan-main-content">
            ...
            <section class="zukan-article-section" id="related-tags">
                <span class="ornament-center">&#10086;</span>
                
                <article class="zukan-article-content">
                    <div class="zukan-article-header">
                        <span class="label-text">Related Tags</span>
                        関連するタグ
                    </div>
                    
                    <div class="zukan-tag-cloud" style="display: flex; flex-wrap: wrap; gap: 8px; padding: 20px 0;">
                        <?php foreach ($related_tags as $related_tag): ?>
                        <a href="<?php echo esc_url(get_term_link($related_tag)); ?>" 
                           class="zukan-tag-link"
                           style="display: inline-block; padding: 8px 16px; background: #f5f5f5; border-radius: 20px; color: #333; text-decoration: none; font-size: 14px; transition: all 0.2s;">
                            #<?php echo esc_html($related_tag->name); ?>
                            <span style="color: #999; font-size: 12px; margin-left: 4px;">(<?php echo $related_tag->count; ?>)</span>
                        </a>
                        <?php endforeach; ?>
                    </div>
                </article>
            ...
            <section class="zukan-article-section" id="guide">
                ...
                <article class="zukan-article-content">
                    <div class="zukan-article-header">
                        ...
                        #<?php echo esc_html($tag_name); ?>に関連する助成金の傾向
                    </div>
                    
                    <div class="zukan-article-columns">
                        <div>
                            <h3>壱. タグの特徴</h3>
                            <p>#<?php echo esc_html($tag_name); ?>に関連する助成金は、特定の政策目標や事業分野に焦点を当てた支援制度です。このタグに関連する制度は国・地方自治体・各種団体から提供されており、申請条件や補助率もさまざまです。最新の募集情報をこまめにチェックすることが重要です。</p>
                        </div>
                        <div>
                            <h3>弐. 申請のコツ</h3>
                            <p>関連する助成金を効率的に探すには、複数のタグやカテゴリを組み合わせて検索することをお勧めします。また、締切間近の制度を見逃さないよう、定期的にサイトをチェックするか、メールマガジンに登録しておくと便利です。</p>
                        </div>
                    </div>
