<?php
/**
 * Purpose Archive Template for Grant - 図鑑風デザイン統一版
 * 用途別助成金アーカイブページ - archive-grant.phpベース
 * 
 * @package Grant_Insight_Perfect
 * @version 21.0.0 - Unified Design with card-zukan.php & sidebar-filters.php
 */
...
$purpose_name = $current_term->name;
$purpose_slug = $current_term->slug;
$purpose_description = $current_term->description;
$purpose_count = $current_term->count;
$purpose_id = $current_term->term_id;
...
// タイトル・説明文の生成
$archive_title = $purpose_name . 'の補助金・助成金';
$archive_description = $purpose_description ?: 
    $purpose_name . 'を目的とした助成金・補助金を' . number_format($purpose_count) . '件掲載。' . 
    $current_year . '年度の最新募集情報を毎日更新。専門家による申請サポート完備。';

// 総件数
$total_grants = $purpose_count;
...
<?php
// title タグ用
$seo_title = $purpose_name . 'の補助金・助成金一覧【' . $current_year . '年度最新版】' . number_format($purpose_count) . '件';
...
<main id="main-content" class="site-main" role="main">
    ...
    <section class="zukan-hero zukan-hero-simple">
        <div class="yahoo-container">
            <div class="zukan-hero-content">
                <span class="zukan-hero-label">Purpose Archive</span>
    ...
    <div class="yahoo-container yahoo-two-column-layout zukan-two-column">
        ...
        <div class="yahoo-main-content zukan-main-content">
            ...
            <section class="gi-section" id="list">
                <header class="gi-section-numbered-header">
                    ...
                    <div class="gi-section-title-box">
                        ...
                        <h2 class="gi-section-title"><?php echo esc_html($purpose_name); ?>の補助金図鑑一覧</h2>
            ...
            <section class="zukan-article-section" id="related-purposes">
                <span class="ornament-center">&#10086;</span>
                
                <article class="zukan-article-content">
                    <div class="zukan-article-header">
                        <span class="label-text">Related Purposes</span>
                        関連する用途
                    </div>
                    
                    <div class="zukan-purpose-list" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 12px; padding: 20px 0;">
                        <?php foreach ($related_purposes as $related_purpose): ?>
                        <a href="<?php echo esc_url(get_term_link($related_purpose)); ?>" 
                           class="zukan-purpose-link"
                           style="display: flex; align-items: center; padding: 12px 16px; background: #f8f8f8; border-radius: 8px; color: #333; text-decoration: none; transition: all 0.2s; border: 1px solid #e0e0e0;">
                            <span style="flex: 1;"><?php echo esc_html($related_purpose->name); ?></span>
                            <span style="color: #999; font-size: 12px;">(<?php echo $related_purpose->count; ?>)</span>
                        </a>
                        <?php endforeach; ?>
                    </div>
                </article>
            ...
            <section class="zukan-article-section" id="guide">
                ...
                <article class="zukan-article-content">
                    <div class="zukan-article-header">
                        ...
                        <?php echo esc_html($purpose_name); ?>の助成金・補助金ガイド
                    </div>
                    
                    <div class="zukan-article-columns">
                        <div>
                            <h3>壱. この用途の特徴</h3>
                            <p><?php echo esc_html($purpose_name); ?>を目的とした助成金は、事業の成長や革新を支援するために設計されています。補助対象となる経費や補助率は制度によって異なりますが、計画的に活用することで事業投資の負担を大幅に軽減できます。</p>
                        </div>
                        <div>
                            <h3>弐. 申請のポイント</h3>
                            <p>この用途の助成金を申請する際は、事業計画の明確性と実現可能性が重要です。投資対効果を具体的な数値で示し、事業の将来性についても説得力のある説明を心がけましょう。専門家への相談も有効な手段です。</p>
                        </div>
                    </div>
